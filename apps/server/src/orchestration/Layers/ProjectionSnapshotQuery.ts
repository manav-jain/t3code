...
const ProjectionThreadDbRowSchema = ProjectionThread.mapFields(
  Struct.assign({
    ...
    slackThreads: Schema.fromJsonString(Schema.Array(ThreadSlackThreadLink)),
  }),
);
    ...
    execute: () =>
      sql`
        SELECT
          ...
          slack_threads_json AS "slackThreads",
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        slackThreads: threadRow.value.slackThreads,
        ...
        groupName: threadRow.value.groupName ?? null,
